                    ...
                    <div className="col-xl-8 col-lg-8">
                        <div className="single-content-wrapper mr-20">
                            <div className="class-details-img mb-40">
                                <img
                                    alt="Thumbnail"
                                    src="/images/1712395696689292091661115b0e963a.png"className="w-100 lazyload courseBannerImage img-fluid"
                                />
                            </div>
                                    ...
                                    <div className="row g-sm-4 g-2">
                                        <div className="col-6">
                                            <div className="class-details-img w_100">
                                                <img
                                                    alt="Thumbnail"
                                                    src="/images/1713843472150735032866272d10793cf.jpeg" className="w-100 lazyload courseBannerImage img-fluid"
                                                />
                                            </div>
                                        </div>
                                        <div className="col-6">
                                            <div className="class-details-img w_100">
                                                <img
                                                    ...
                                                    data-src="https://amadereshkul.s3-ap-southeast-1.amazonaws.com/4394ac/bda43601-2d16-4f14-9bd5-2fa215b18270/lms/1713843477104602214966272d15d5f07.jpeg"
                                ...
                                <div className="sidebar-popular-class px-30 p-30">
                                    <a href="abacus-math-beginner.html" className="d-flex mb-20">
                                        <div className="class-thumb mr-20">
                                            <img
                                                alt="Thumbnail" src="/images/172095693418547859776693b8066ca10.png"
                                                className="w-100 lazyload courseBannerImage img-fluid"
                                            />
                                        </div>
                                    ...
                                    >
                                        <div className="class-thumb mr-20">
                                            <img
                                                alt="Thumbnail" src="/images/172095693418547859776693b8066ca10.png" className="w-100 lazyload courseBannerImage img-fluid"
                                            />
                                        </div>
                                        <div className="sidebar-class-txt">
                                            <span className="sidebar-sub-txt mb-5">Abacus Math</span>
                                    ...
                                    >
                                        <div className="class-thumb mr-20">
                                            <img
                                                alt="Thumbnail"
                                                src="/images/172095693418547859776693b8066ca10.png" className="w-100 lazyload courseBannerImage img-fluid"
                                            />
                                        </div>
                                        <div className="sidebar-class-txt">
                                            <span className="sidebar-sub-txt mb-5">Abacus Math</span>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-6">
                                            <div className="section-question-img">
                                                <img
                                                    src="../../amadereshkul.s3-ap-southeast-1.amazonaws.com/4394ac/bda43601-2d16-4f14-9bd5-2fa215b18270/171344163814536180866210b6637fb6.png"
                                                    alt=""
                                                    className=""
                                                />
                                            </div>
